...
public:
    ...
    */
    ...
    /** Get the first child element, or optionally the first child
        element with the specified name.
        Throws a std::runtime_error if not found
    */
    const XMLElement* FirstChildElementThrow(const char* name = 0) const;

    XMLElement* FirstChildElementThrow(const char* name = 0) {
        return const_cast<XMLElement*>(const_cast<const XMLNode*>(this)->FirstChildElementThrow(name));
    }
...
public:
    ...
    */
    void LoadFileThrow(const char* filename);
